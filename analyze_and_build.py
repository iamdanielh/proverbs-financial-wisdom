    ...
    if chapter_num == 1:
        ...
        insight = {
            ...
            "key_insights": [
                ...
                "Abundance comes to those who prepare" ], "proverbs_says": "Wealth without reserves is like summer without winter preparation. The ant teaches: store in season, consume when needed.", "color": "#f57c00", "icon": "📦" } elif chapter_num == 9: insight = { "title": title, "headline": "Choose wisdom over gold every time", "summary": "Wisdom is more precious than rubies; nothing you desire compares. Get wisdom though it costs everything—it's worth infinitely more.", "key_insights": [ "Wisdom > all material wealth", "True value is non-exchangeable", "Security comes from wisdom, not cash" ], "proverbs_says": "Most value wealth over wisdom. Proverbs corrects this: wisdom produces wealth, not vice versa. The ROI is eternal.", "color": "#6a1b9a", "icon": "💎" } elif chapter_num == 10: insight = { "title": title, "headline": "Integrity is non-negotiable in business", "summary": "A false balance is abomination; just weights please Yahweh. Honest dealing builds lasting foundations; deceit destroys everything.", "key_insights": [ "Honest scales matter to God", "Short-term gain = long-term ruin", "Reputation is built on integrity" ], "proverbs_says": "Dishonest money dwindles. The just balance is found out—so use it from the start. False weights are spiritual fraud.", "color": "#37474f", "icon": "⚖️" } elif chapter_num == 11: insight = { "title": title, "headline": "Build legacy, not just bank accounts", "summary": "A good name is more valuable than riches. Train children, leave inheritance—but character compounds more than cash.", "key_insights": [ "Name outlasts net worth", "Children are your legacy", "Character compounds across generations" ], "proverbs_says": "The house of the righteous stands. Build a lasting name, not just a bank account. Wealth transfers; character compounds.", "color": "#5d4037", "icon": "🌳" } elif chapter_num == 12: insight = { "title": title, "headline": "Fair wages build trust and loyalty", "summary": "The laborer is worthy of hire. Withhold not wages overnight. Fair dealing creates lasting relationships.", "key_insights": [ "Pay promptly", "Workers deserve fair reward", "Integrity in employment matters" ], "proverbs_says": "Don't sleep while workers wait for pay. Fair wages given quickly build trust and honor. Laborer worthiness is non-negotiable.", "color": "#00796b", "icon": "💵" } else: insight = { "title": title, "headline": f"Chapter {chapter_num}", "summary": "Wisdom from Proverbs for financial living", "key_insights": ["Study the chapter"], "proverbs_says": "Study the full chapter.", "color": "#607d8b", "icon": "📖" } return insight